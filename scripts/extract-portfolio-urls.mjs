...
async function extractUrls() {
  ...
  await page.goto("https://www.lannkin.fr/portfolio/", { waitUntil: "networkidle2", timeout: 30000 });
  ...
  const externalLinks = await page.evaluate(() => {
    ...
    return [...anchors]
      ...
      .filter((l) => !l.href.includes("lannkin.fr") && !l.href.includes("mailto") && l.href.startsWith("http"));
  });
