 ...
 * Récupère tous les articles du blog lannkin.ca via l'API REST WordPress
...
async function migrate() {
  ...
  // Supprimer les images WordPress internes (hébergées sur lannkin.ca)
  ...
  turndown.addRule("wpImages", {
    ...
    replacement: (content, node) => {
      ...
      if (src && !src.includes("lannkin.ca") && !src.includes("wp-content")) {
        return `![${alt}](${src})`;
      }
