...
const conceptionWebSubs: ServiceData[] = [
  ...
  },
  {
    ...
    parentSlug: "conception-web",
    icon: "ShoppingBag",
    shortDescription: "Agence web Shopify au Québec : création de boutiques e-commerce, développement Liquid, optimisation conversion et stratégie marketing.",
    metaTitle: "Agence Web Shopify Laval & Montréal | LANNKIN",
    metaDescription: "Agence web Shopify à Laval et Montréal. Création boutiques Shopify, développement Liquid, optimisation conversion. +150 000 $ générés.",
    keywords: ["agence web shopify", "agence shopify montréal", "agence shopify laval", "création boutique shopify", "expert shopify canada", "shopify québec", "développeur shopify", "agence e-commerce shopify"],
...
const googleAds: ServiceData = {
  ...
  metaTitle: "Agence Web Laval | Google Ads Certifié Google Partner | LANNKIN",
  metaDescription: "Agence web à Laval certifiée Google Partner. Google Ads Search, Display, Shopping, YouTube, PMax. +100K$/mois de budget géré. Devis gratuit.",
  keywords: ["agence web laval", "google ads laval", "agence google ads montréal", "google ads québec", "sem laval", "ppc montréal", "agence marketing laval"],
...
const googleAdsSubs: ServiceData[] = [
  ...
  { slug: "campagne-discovery", name: "Campagne Discovery", category: "paid-media", parentSlug: "google-ads", icon: "Compass", shortDescription: "Annonces Discovery sur Gmail, YouTube et Discover. Format natif, audience en phase de découverte.", metaTitle: "Google Discovery Ads | LANNKIN Laval", metaDescription: "Campagnes Discovery Ads à Laval. Annonces natives sur Gmail, YouTube, Discover. Audiences en phase de découverte.", keywords: ["discovery ads laval", "google discovery montréal", "annonces discover", "gmail ads québec"], relatedServices: ["campagne-display", "campagne-youtube", "native-ads"], relatedSectors: ["tourisme", "commerce-detail"], relatedBlogCategories: ["google-ads"], pricingLink: "/tarifs/google-ads/", stripeLinks: [] },
...
const facebookAdsSubs: ServiceData[] = [
  { slug: "campagne-facebook", name: "Campagne Facebook", category: "paid-media", parentSlug: "facebook-ads", icon: "ThumbsUp", shortDescription: "Publicités Facebook : lead gen, trafic, conversions. Ciblage démographique et comportemental.", metaTitle: "Publicité Facebook Laval | Meta Partner", metaDescription: "Campagnes publicitaires Facebook à Laval. Lead gen, trafic, conversions. Ciblage précis. Meta Partner certifié.", keywords: ["publicité facebook laval", "facebook ads montréal", "campagne facebook québec", "pub facebook"], relatedServices: ["campagne-instagram", "retargeting-facebook", "google-ads", "lead-generation"], relatedSectors: ["beaute", "restaurant-restauration", "commerce-detail"], relatedBlogCategories: ["facebook-ads"], pricingLink: "/tarifs/facebook-ads/", stripeLinks: [] },
  { slug: "campagne-instagram", name: "Campagne Instagram", category: "paid-media", parentSlug: "facebook-ads", icon: "Camera", shortDescription: "Publicités Instagram : stories, reels, feed, explore. Visuels impactants pour conversions.", metaTitle: "Publicité Instagram Laval | Reels & Stories", metaDescription: "Campagnes Instagram Ads à Laval. Stories, Reels, feed, explore. Visuels créatifs pour engagement et conversions.", keywords: ["instagram ads laval", "publicité instagram montréal", "reels ads québec", "stories instagram pub"], relatedServices: ["campagne-facebook", "tiktok-ads", "graphisme", "retargeting-facebook"], relatedSectors: ["beaute", "restaurant-restauration", "tourisme"], relatedBlogCategories: ["facebook-ads", "reseaux-sociaux"], pricingLink: "/tarifs/facebook-ads/", stripeLinks: [] },
...
const amazonAdsSubs: ServiceData[] = [
  { slug: "amazon-sponsored-products", name: "Amazon Sponsored Products", category: "paid-media", parentSlug: "amazon-ads", icon: "Tag", shortDescription: "Sponsored Products Amazon. Ciblage par produit et mots-clés. Bidding optimisé.", metaTitle: "Amazon Sponsored Products | Expert LANNKIN", metaDescription: "Amazon Sponsored Products à Laval. Ciblage produit, keywords, bidding optimisé. Augmentez vos ventes Amazon.", keywords: ["amazon sponsored products", "ppc amazon", "publicité produit amazon", "amazon ads produit"], relatedServices: ["amazon-sponsored-brands", "campagne-shopping", "seo"], relatedSectors: ["ecommerce"], relatedBlogCategories: ["ecommerce"], pricingLink: null, stripeLinks: [] },
  { slug: "amazon-sponsored-brands", name: "Amazon Sponsored Brands", category: "paid-media", parentSlug: "amazon-ads", icon: "Award", shortDescription: "Sponsored Brands Amazon. Bannières marque, vidéo, store spotlight. Visibilité premium.", metaTitle: "Amazon Sponsored Brands | Visibilité Marque", metaDescription: "Amazon Sponsored Brands à Laval. Bannières, vidéo, store spotlight. Visibilité premium pour votre marque.", keywords: ["amazon sponsored brands", "amazon brand ads", "publicité marque amazon", "amazon brand visibility"], relatedServices: ["amazon-sponsored-products", "strategie-amazon-advertising", "graphisme"], relatedSectors: ["ecommerce", "commerce-detail"], relatedBlogCategories: ["ecommerce"], pricingLink: null, stripeLinks: [] },
  { slug: "strategie-amazon-advertising", name: "Stratégie Amazon Advertising", category: "paid-media", parentSlug: "amazon-ads", icon: "Lightbulb", shortDescription: "Stratégie Amazon Ads globale. Quand et comment utiliser Amazon comme canal d'acquisition.", metaTitle: "Stratégie Amazon Ads | Expert Québec", metaDescription: "Stratégie Amazon Advertising à Laval. Plan PPC Amazon complet. Quand et comment utiliser Amazon Ads efficacement.", keywords: ["stratégie amazon ads", "amazon advertising plan", "consultant amazon québec", "amazon marketing"], relatedServices: ["amazon-sponsored-products", "amazon-sponsored-brands", "google-ads", "site-shopify"], relatedSectors: ["ecommerce"], relatedBlogCategories: ["ecommerce"], pricingLink: null, stripeLinks: [] },
];
...
const seoSubs: ServiceData[] = [
  ...
  { slug: "referencement-local", name: "Référencement Local", category: "seo", parentSlug: "seo", icon: "MapPin", shortDescription: "SEO local pour apparaître dans Google Maps et le pack local. NAP, citations, avis.", metaTitle: "SEO Local Laval & Montréal | LANNKIN", metaDescription: "Référencement local à Laval. Google Maps, pack local, NAP, citations, avis Google. Attirez les clients proches.", keywords: ["seo local laval", "référencement local montréal", "google maps seo", "pack local google", "seo local québec"], relatedServices: ["google-my-business", "waze-ads", "campagne-google-maps", "audit-seo"], relatedSectors: ["restaurant-restauration", "sante", "beaute", "automobile"], relatedBlogCategories: ["seo", "google-my-business"], pricingLink: "/tarifs/seo/", stripeLinks: [] },
  ...
  { slug: "seo-ecommerce", name: "SEO E-commerce", category: "seo", parentSlug: "seo", icon: "ShoppingCart", shortDescription: "SEO spécialisé e-commerce. Fiches produits, catégories, rich snippets, vitesse.", metaTitle: "SEO E-commerce Laval | Shopify WordPress", metaDescription: "SEO e-commerce à Laval. Fiches produits, catégories, rich snippets. Shopify, WooCommerce, Odoo. Plus de ventes.", keywords: ["seo ecommerce laval", "référencement boutique en ligne", "seo shopify", "seo woocommerce", "seo produits"], relatedServices: ["site-shopify", "amazon-ads", "google-ads", "odoo-ecommerce"], relatedSectors: ["ecommerce", "commerce-detail"], relatedBlogCategories: ["seo", "ecommerce"], pricingLink: "/tarifs/seo/", stripeLinks: [] },
...
const sites3dSubs: ServiceData[] = [
  ...
  { slug: "site-threejs", name: "Site Three.js", category: "web", parentSlug: "sites-immersifs-3d", icon: "Box", shortDescription: "Sites web Three.js : scènes 3D interactives, animations, effets visuels immersifs.", metaTitle: "Site Three.js Laval | Développeur 3D Web", metaDescription: "Développement de sites Three.js à Laval. Scènes 3D interactives, animations, effets immersifs. Expert WebGL.", keywords: ["three.js laval", "développeur threejs", "site 3d montréal", "three.js développement", "threejs expert"], relatedServices: ["experience-webgl", "react-three-fiber", "animation-3d-web"], relatedSectors: ["tourisme", "automobile", "immobilier"], relatedBlogCategories: ["conception-web"], pricingLink: null, stripeLinks: [] },
...
const montageVideoSubs: ServiceData[] = [
  // --- Par plateforme ---
  { slug: "montage-video-youtube", name: "Montage Vidéo YouTube", category: "creative", parentSlug: "montage-video", icon: "Youtube", shortDescription: "Montage vidéo YouTube professionnel. Intros, transitions, sous-titres, miniatures, optimisation SEO YouTube.", metaTitle: "Montage Vidéo YouTube | LANNKIN Laval", metaDescription: "Montage vidéo YouTube professionnel à Laval. Script, voix-off, effets visuels, miniatures. Boostez votre chaîne YouTube.", keywords: ["montage vidéo youtube", "monteur youtube", "vidéo youtube professionnel", "création vidéo youtube", "éditeur vidéo youtube laval"], relatedServices: ["montage-video-tiktok", "montage-video-shorts-reels", "google-ads"], relatedSectors: ["restaurant-restauration", "beaute", "education"], relatedBlogCategories: ["reseaux-sociaux"], pricingLink: "/tarifs/montage-video/", stripeLinks: [] },
  { slug: "montage-video-tiktok", name: "Montage Vidéo TikTok", category: "creative", parentSlug: "montage-video", icon: "Music", shortDescription: "Montage vidéo TikTok accrocheur. Format vertical, tendances, hooks percutants, effets viraux.", metaTitle: "Montage Vidéo TikTok | Création Contenu Viral", metaDescription: "Montage vidéo TikTok à Laval. Contenu viral, tendances, hooks percutants. Augmentez votre visibilité sur TikTok.", keywords: ["montage vidéo tiktok", "vidéo tiktok professionnel", "création contenu tiktok", "monteur tiktok", "vidéo virale tiktok"], relatedServices: ["montage-video-shorts-reels", "montage-video-youtube", "tiktok-ads"], relatedSectors: ["restaurant-restauration", "beaute", "commerce-detail"], relatedBlogCategories: ["reseaux-sociaux"], pricingLink: "/tarifs/montage-video/", stripeLinks: [] },
  ...
  { slug: "montage-video-instagram", name: "Montage Vidéo Instagram", category: "creative", parentSlug: "montage-video", icon: "Camera", shortDescription: "Montage vidéo Instagram : Stories, Reels, publications vidéo. Contenu esthétique et engageant.", metaTitle: "Montage Vidéo Instagram | Contenu Visuel Pro", metaDescription: "Montage vidéo Instagram à Laval. Stories, Reels, publications. Contenu esthétique qui engage votre audience.", keywords: ["montage vidéo instagram", "vidéo instagram professionnel", "stories instagram", "contenu instagram vidéo"], relatedServices: ["montage-video-shorts-reels", "montage-video-tiktok", "facebook-ads"], relatedSectors: ["beaute", "restaurant-restauration", "tourisme"], relatedBlogCategories: ["reseaux-sociaux"], pricingLink: "/tarifs/montage-video/", stripeLinks: [] },
  ...
  { slug: "video-anniversaire", name: "Vidéo Anniversaire", category: "creative", parentSlug: "montage-video", icon: "PartyPopper", shortDescription: "Montage vidéo anniversaire et fêtes. Rétrospective, diaporama animé, vidéo surprise personnalisée.", metaTitle: "Montage Vidéo Anniversaire | Vidéo Fête", metaDescription: "Montage vidéo anniversaire à Laval. Rétrospective, diaporama animé, vidéo surprise. Un cadeau original et émouvant.", keywords: ["montage vidéo anniversaire", "vidéo anniversaire", "vidéo fête", "diaporama anniversaire", "vidéo surprise"], relatedServices: ["video-mariage", "video-evenementiel", "montage-video-youtube"], relatedSectors: ["tourisme"], relatedBlogCategories: ["marketing-digital"], pricingLink: "/tarifs/montage-video/", stripeLinks: [] },
