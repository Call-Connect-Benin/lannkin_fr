...
const conceptionWebSubs: ServiceData[] = [
  {
    ...
    metaTitle: "Création Site Vitrine à Paris | EKOLINK",
  ...
  },
  {
    ...
    metaTitle: "Création Site WordPress Paris | EKOLINK",
  ...
  },
  {
    ...
    metaTitle: "Agence Web Shopify Paris & Paris | EKOLINK",
    ...
    keywords: ["agence web shopify", "agence shopify paris", "agence shopify paris", "création boutique shopify", "expert shopify canada", "shopify france", "développeur shopify", "agence e-commerce shopify"],
  ...
  },
  {
    ...
    metaTitle: "Développement Next.js Paris | EKOLINK",
  ...
  },
  {
    ...
    metaTitle: "Headless CMS Paris | Strapi, Sanity | EKOLINK",
    ...
    keywords: ["headless cms paris", "strapi paris", "sanity france", "cms découplé", "jamstack canada", "headless wordpress"],
  ...
  },
  {
    ...
    metaTitle: "Refonte Site Web Paris & Paris | EKOLINK",
...
const vibeCoding: ServiceData = {
  ...
  keywords: ["vibe coding paris", "cms ia paris", "lovable expert france", "cursor ai canada", "bolt.new agence", "développement ia"],
...
const vibeCodingSubs: ServiceData[] = [
  {
    ...
    metaTitle: "Expert Lovable à Paris | Apps IA | EKOLINK",
  ...
  },
  {
    ...
    metaTitle: "Expert Bolt.new | Prototypage IA | EKOLINK",
    ...
    keywords: ["bolt new développeur", "bolt.new agence", "prototypage ia paris", "bolt new expert", "bolt new canada"],
  ...
  },
  {
    ...
    metaTitle: "Expert Cursor AI | IDE IA | EKOLINK Paris",
    metaDescription: "Expert Cursor AI à Paris. IDE augmenté par IA pour développeurs. Setup, configuration, optimisation workflow.",
    keywords: ["cursor ai expert", "cursor ide france", "cursor ai développeur", "ide ia canada", "cursor ai agence"],
  ...
  },
  {
    ...
    metaTitle: "Expert Claude Code | Agent IA | EKOLINK",
    metaDescription: "Expert Claude Code à Paris. Agent terminal IA d'Anthropic pour refactoring, gros codebases. Deep reasoning.",
    keywords: ["claude code expert", "claude code agence", "anthropic claude france", "agent ia terminal", "claude code canada"],
  ...
  },
  {
    ...
    metaTitle: "Expert v0 Vercel | Composants React IA | EKOLINK",
    metaDescription: "Expert v0 by Vercel. Génération de composants React et Next.js par IA. Templates et déploiement Vercel.",
    keywords: ["v0 vercel expert", "v0 développeur", "v0 react france", "vercel agence canada", "composants ia"],
  ...
  },
  {
    ...
    metaTitle: "Expert Windsurf IDE IA | EKOLINK Paris",
    metaDescription: "Expert Windsurf à Paris. IDE avec agent IA autonome. Tests automatiques et corrections intelligentes.",
    keywords: ["windsurf ide", "windsurf expert", "windsurf ia france", "ide agent autonome", "windsurf canada"],
  ...
  },
  {
    ...
    metaTitle: "Expert Replit | Dev Full-Stack IA | EKOLINK",
    metaDescription: "Expert Replit à Paris. IDE cloud avec agents IA autonomes. Collaboration, prototypage rapide, formation.",
    keywords: ["replit expert", "replit agence", "replit france", "ide cloud ia", "replit agent canada"],
  ...
  },
  {
    ...
    metaTitle: "Maintenance App Vibe Coding | EKOLINK",
  ...
  },
  {
    ...
    metaTitle: "Formation Vibe Coding Paris | EKOLINK",
  ...
  },
  {
    ...
    metaTitle: "Audit Code IA | Sécurité & Qualité | EKOLINK",
  ...
  },
  {
    ...
    metaTitle: "Migration App IA → Production | EKOLINK",
...
const odoo: ServiceData = {
  ...
  metaTitle: "Expert Odoo Paris & Paris | ERP CRM | EKOLINK",
  ...
  keywords: ["odoo paris", "intégrateur odoo paris", "odoo france", "erp odoo canada", "odoo pme", "agence odoo"],
...
const odooSubs: ServiceData[] = [
  {
    ...
    metaTitle: "Création Site Web Odoo à Paris | EKOLINK",
  ...
  },
  {
    ...
    metaTitle: "Intégration Odoo ERP pour PME | EKOLINK",
  ...
  },
  {
    ...
    metaTitle: "CRM Odoo | Gestion Client | EKOLINK Paris",
  ...
  },
  {
    ...
    metaTitle: "SEO Odoo | Référencement Site Odoo | EKOLINK",
  ...
  },
  {
    ...
    metaTitle: "Maintenance Odoo | Support & MAJ | EKOLINK",
  ...
  },
  {
    ...
    metaTitle: "Migration vers Odoo | WordPress → Odoo | EKOLINK",
  ...
  },
  {
    ...
    metaTitle: "Formation Odoo Entreprises | EKOLINK Paris",
...
const googleAds: ServiceData = {
  ...
  metaTitle: "Agence Web Paris | Google Ads Certifié Google Partner | EKOLINK",
...
const googleAdsSubs: ServiceData[] = [
  ...
  { slug: "campagne-discovery", name: "Campagne Discovery", category: "paid-media", parentSlug: "google-ads", icon: "Compass", shortDescription: "Annonces Discovery sur Gmail, YouTube et Discover. Format natif, audience en phase de découverte.", metaTitle: "Google Discovery Ads | EKOLINK Paris", metaDescription: "Campagnes Discovery Ads à Paris. Annonces natives sur Gmail, YouTube, Discover. Audiences en phase de découverte.", keywords: ["discovery ads paris", "google discovery paris", "annonces discover", "gmail ads france"], relatedServices: ["campagne-display", "campagne-youtube", "native-ads"], relatedSectors: ["tourisme", "commerce-detail"], relatedBlogCategories: ["google-ads"], pricingLink: "/tarifs/google-ads/", stripeLinks: [] },
...
const facebookAdsSubs: ServiceData[] = [
  ...
  { slug: "campagne-meta-advantage", name: "Campagne Meta Advantage+", category: "paid-media", parentSlug: "facebook-ads", icon: "Cpu", shortDescription: "Meta Advantage+ : campagnes automatisées par IA. Shopping, App, Audiences élargies.", metaTitle: "Meta Advantage+ Ads | Expert EKOLINK", metaDescription: "Campagnes Meta Advantage+ à Paris. Automatisation IA pour Shopping, App et audiences. Optimisation ROAS maximale.", keywords: ["meta advantage", "advantage+ ads", "meta advantage paris", "facebook advantage shopping"], relatedServices: ["campagne-facebook", "campagne-instagram", "campagne-performance-max"], relatedSectors: ["ecommerce", "commerce-detail"], relatedBlogCategories: ["facebook-ads"], pricingLink: "/tarifs/facebook-ads/", stripeLinks: [] },
];
...
const tiktokAdsSubs: ServiceData[] = [
  { slug: "campagne-tiktok", name: "Campagne TikTok", category: "paid-media", parentSlug: "tiktok-ads", icon: "Play", shortDescription: "Création et gestion de campagnes TikTok : in-feed, branded hashtag, spark ads.", metaTitle: "Campagne TikTok Ads Paris | EKOLINK", metaDescription: "Création de campagnes TikTok Ads à Paris. In-feed, branded hashtag, spark ads. CPC 0.20-1$. Résultats garantis.", keywords: ["campagne tiktok paris", "tiktok in-feed ads", "spark ads", "tiktok pub paris"], relatedServices: ["campagne-instagram", "campagne-snapchat", "graphisme"], relatedSectors: ["beaute", "commerce-detail"], relatedBlogCategories: ["reseaux-sociaux"], pricingLink: "/tarifs/reseaux-sociaux/", stripeLinks: [] },
];
...
const pinterestAds: ServiceData = {
  ...
  metaTitle: "Agence Pinterest Ads Paris | EKOLINK", metaDescription: "Agence Pinterest Ads à Paris. Épingles sponsorisées, Shopping ads. Trafic qualifié en phase d'inspiration. 700€/mois.",
...
const pinterestAdsSubs: ServiceData[] = [
  { slug: "campagne-pinterest", name: "Campagne Pinterest", category: "paid-media", parentSlug: "pinterest-ads", icon: "Image", shortDescription: "Épingles sponsorisées, shopping pins et vidéo pins. Audience en phase d'achat.", metaTitle: "Campagne Pinterest Ads Paris | EKOLINK", metaDescription: "Campagnes Pinterest Ads à Paris. Épingles sponsorisées, shopping pins. Audience en phase d'achat et d'inspiration.", keywords: ["campagne pinterest paris", "shopping pins", "pinterest ads paris", "épingles pub"], relatedServices: ["campagne-instagram", "graphisme", "facebook-ads"], relatedSectors: ["beaute", "commerce-detail"], relatedBlogCategories: ["reseaux-sociaux"], pricingLink: "/tarifs/reseaux-sociaux/", stripeLinks: [] },
];
...
const nativeAds: ServiceData = {
  ...
  keywords: ["native ads paris", "taboola paris", "outbrain france", "publicité native", "traffic factory canada", "native advertising"],
...
const nativeAdsSubs: ServiceData[] = [
  ...
  { slug: "traffic-factory", name: "Traffic Factory", category: "paid-media", parentSlug: "native-ads", icon: "Flame", shortDescription: "Expert Traffic Factory au Canada. Campagnes sur réseau adulte : display, native, pop-under. CPC ultra-compétitif.", metaTitle: "Expert Traffic Factory Canada | EKOLINK", metaDescription: "Expert Traffic Factory au Canada. +7 ans d'expertise. Campagnes réseau adulte : display, native, pop-under. CPC compétitif.", keywords: ["traffic factory canada", "expert traffic factory", "publicité site adulte", "native ads adulte", "traffic factory paris", "agence traffic factory"],
  ...
  { slug: "revcontent", name: "Revcontent", category: "paid-media", parentSlug: "native-ads", icon: "FileText", shortDescription: "Campagnes Revcontent : CPC compétitif, formats natifs premium, alternative Taboola/Outbrain.", metaTitle: "Campagne Revcontent | Native Ads | EKOLINK", metaDescription: "Campagnes Revcontent à Paris. CPC compétitif, formats premium. Alternative performante à Taboola et Outbrain.", keywords: ["revcontent ads", "revcontent france", "revcontent campagne", "native ads alternative"], relatedServices: ["campagne-taboola", "campagne-outbrain", "traffic-factory"], relatedSectors: ["ecommerce"], relatedBlogCategories: ["marketing-digital"], pricingLink: "/tarifs/native-ads/", stripeLinks: [] },
  { slug: "installation-tags-natifs", name: "Installation Tags Natifs", category: "paid-media", parentSlug: "native-ads", icon: "Code", shortDescription: "Installation des tags de conversion Taboola, Outbrain, Traffic Factory, Revcontent.", metaTitle: "Installation Tags Natifs | EKOLINK", metaDescription: "Installation tags de conversion pour Taboola, Outbrain, Traffic Factory, Revcontent. Suivi précis. 250$.", keywords: ["installation tags natifs", "tracking taboola", "tag outbrain", "conversion native ads"], relatedServices: ["installation-tracking", "campagne-taboola", "campagne-outbrain"], relatedSectors: [], relatedBlogCategories: ["marketing-digital"], pricingLink: "/tarifs/native-ads/", stripeLinks: [] },
...
const amazonAdsSubs: ServiceData[] = [
  { slug: "amazon-sponsored-products", name: "Amazon Sponsored Products", category: "paid-media", parentSlug: "amazon-ads", icon: "Tag", shortDescription: "Sponsored Products Amazon. Ciblage par produit et mots-clés. Bidding optimisé.", metaTitle: "Amazon Sponsored Products | Expert EKOLINK", metaDescription: "Amazon Sponsored Products à Paris. Ciblage produit, keywords, bidding optimisé. Augmentez vos ventes Amazon.", keywords: ["amazon sponsored products", "ppc amazon", "publicité produit amazon", "amazon ads produit"], relatedServices: ["amazon-sponsored-brands", "campagne-shopping", "seo"], relatedSectors: ["ecommerce"], relatedBlogCategories: ["ecommerce"], pricingLink: null, stripeLinks: [] },
...
const gmbSubs: ServiceData[] = [
  ...
  { slug: "collecte-avis-google", name: "Collecte Avis Google", category: "seo", parentSlug: "google-my-business", icon: "Star", shortDescription: "Stratégie de collecte d'avis Google. Automatisation, QR codes, suivi réputation.", metaTitle: "Collecte Avis Google | 4.9/5 | EKOLINK", metaDescription: "Collecte d'avis Google à Paris. Stratégie automatisée, QR codes, suivi réputation. Comme nous : 4.9/5 sur 54 avis.", keywords: ["collecte avis google", "avis google paris", "obtenir avis google", "stratégie avis", "achatavis"], relatedServices: ["optimisation-fiche-gmb", "qr-code-avis", "gestion-avis-negatifs"], relatedSectors: ["restaurant-restauration", "sante", "automobile"], relatedBlogCategories: ["google-my-business"], pricingLink: "/tarifs/google-my-business/", stripeLinks: [] },
  { slug: "gestion-avis-negatifs", name: "Gestion Avis Négatifs", category: "seo", parentSlug: "google-my-business", icon: "ShieldAlert", shortDescription: "Gestion professionnelle des avis négatifs. Réponses stratégiques, médiation, amélioration.", metaTitle: "Gestion Avis Négatifs Google | EKOLINK", metaDescription: "Gestion des avis négatifs Google à Paris. Réponses stratégiques, médiation, amélioration de votre e-réputation.", keywords: ["gestion avis négatifs", "répondre avis google", "e-réputation", "avis négatifs solutions"], relatedServices: ["collecte-avis-google", "optimisation-fiche-gmb"], relatedSectors: ["restaurant-restauration", "sante"], relatedBlogCategories: ["google-my-business"], pricingLink: "/tarifs/google-my-business/", stripeLinks: [] },
...
const graphismeSubs: ServiceData[] = [
  ...
  { slug: "identite-visuelle", name: "Identité Visuelle", category: "creative", parentSlug: "graphisme", icon: "Brush", shortDescription: "Identité visuelle complète : logo, palette, typo, charte, déclinaisons supports.", metaTitle: "Identité Visuelle Paris | Branding | 1000$", metaDescription: "Création d'identité visuelle complète à Paris. Logo, palette, typo, charte graphique. Branding cohérent. 1000$.", keywords: ["identité visuelle paris", "branding paris", "charte graphique france", "image de marque", "design branding"], relatedServices: ["creation-logo", "conception-web", "carte-de-visite", "brochure-commerciale"], relatedSectors: ["services-professionnels", "beaute"], relatedBlogCategories: ["graphisme"], pricingLink: "/tarifs/graphisme/", stripeLinks: [] },
  ...
  { slug: "carte-de-visite", name: "Carte de Visite", category: "creative", parentSlug: "graphisme", icon: "CreditCard", shortDescription: "Design de cartes de visite professionnelles. Finitions premium, impression qualité.", metaTitle: "Carte de Visite Design Paris | EKOLINK", metaDescription: "Design de cartes de visite professionnelles à Paris. Finitions premium, impression haute qualité. Cohérence de marque.", keywords: ["carte de visite paris", "design carte visite paris", "carte visite pro", "carte professionnelle"], relatedServices: ["creation-logo", "identite-visuelle"], relatedSectors: ["services-professionnels", "immobilier"], relatedBlogCategories: ["graphisme"], pricingLink: "/tarifs/graphisme/", stripeLinks: [] },
];
...
const iaSubs: ServiceData[] = [
  ...
  { slug: "methodologie-deploiement-ia-30-jours", name: "Méthodologie Déploiement IA 30 Jours", category: "ai", parentSlug: "intelligence-artificielle", icon: "CalendarDays", shortDescription: "Déployez votre premier agent IA en 30 jours. Méthodologie éprouvée et rapide.", metaTitle: "Déploiement IA en 30 Jours | EKOLINK", metaDescription: "Déploiement IA en 30 jours à Paris. Méthodologie éprouvée : audit J1-J5, prototypage J6-J15, déploiement J16-J30.", keywords: ["déploiement ia 30 jours", "ia rapide", "méthodologie ia", "implémentation ia", "projet ia rapide"], relatedServices: ["consultant-ia-transformation-digitale", "agents-ia-sur-mesure", "pack-ia-pme-eti"], relatedSectors: ["services-professionnels"], relatedBlogCategories: ["intelligence-artificielle"], pricingLink: null, stripeLinks: [] },
...
const developpementSaas: ServiceData = {
  ...
  metaTitle: "Développement SaaS & Apps Paris | EKOLINK", metaDescription: "Développement SaaS et applications à Paris. Apps web, mobiles, MVPs startup, APIs. De l'idée au produit scalable.",
...
const montageVideoSubs: ServiceData[] = [
  // --- Par plateforme ---
  { slug: "montage-video-youtube", name: "Montage Vidéo YouTube", category: "creative", parentSlug: "montage-video", icon: "Youtube", shortDescription: "Montage vidéo YouTube professionnel. Intros, transitions, sous-titres, miniatures, optimisation SEO YouTube.", metaTitle: "Montage Vidéo YouTube | EKOLINK Paris", metaDescription: "Montage vidéo YouTube professionnel à Paris. Script, voix-off, effets visuels, miniatures. Boostez votre chaîne YouTube.", keywords: ["montage vidéo youtube", "monteur youtube", "vidéo youtube professionnel", "création vidéo youtube", "éditeur vidéo youtube paris"], relatedServices: ["montage-video-tiktok", "montage-video-shorts-reels", "google-ads"], relatedSectors: ["restaurant-restauration", "beaute", "education"], relatedBlogCategories: ["reseaux-sociaux"], pricingLink: "/tarifs/montage-video/", stripeLinks: [] },
