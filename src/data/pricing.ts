...
export const PRICING_CONCEPTION_WEB: PricingPlan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "Design moderne, responsive (mobile, tablette, PC)",
      "Nom de domaine + SSL inclus",
      "Formulaire de contact intégré",
      "Hébergement, maintenance et sécurisation",
      "Fiche Google Mon Entreprise optimisée",
      "Page pro sur les réseaux sociaux (Facebook, Instagram ou LinkedIn)",
      "Création de QR Code personnalisé",
      "Publication de lancement incluse",
    ],
    cta: "Choisir le Pack Smart",
    paymentLink: "https://buy.stripe.com/8x2dRa9I37KEfWWawn6wE3b",
  },
];
