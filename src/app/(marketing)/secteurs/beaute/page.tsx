...
export const metadata: Metadata = {
  ...
  keywords: [
    "marketing digital salon coiffure paris",
    "instagram ads esthétique paris",
    "seo spa paris",
    "booking en ligne salon beauté france",
    "publicité barbier paris",
    "marketing esthéticienne paris",
  ],
...
const BENEFITS = [
  ...
  "SEO local pour 'salon coiffure paris', 'spa paris', 'barbier paris' et plus encore",
